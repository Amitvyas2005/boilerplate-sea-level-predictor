...
def draw_plot():
    ...
    line1_y = [slope1 * year + intercept1 for year in years1]
    ax.plot(years1, line1_y, 'r')
    
    # Create second line of best fit using data from 2000 onwards (2000-2050)
    ...
    line2_y = [slope2 * year + intercept2 for year in years2]
    ax.plot(years2, line2_y, 'g')
